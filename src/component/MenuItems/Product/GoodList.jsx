...
function GoodList() {
  ...
  const delGoods = async (id) => {
    const res = await apis.goods.delGoods({ id });
    if (res.data.code == 1) {
      console.log(res);
  ...
  const columns = [
    ...
    //         height={60}
    //         // src={
    //         //   value?.includes("http://127.0.0.1:8002")
    //         //     ? value
    //         //     : "http://127.0.0.1:8002/images/goods/" + value
    //         // }
    ...
    },
    {
      ...
      render: (_id) => (
        <Space>
          ...
          <Button onClick={() => gotoUpdate(_id)} type="primary">
            修改
          </Button>
        </Space>
      ),
